...
import { getCarByID, postCar, deleteCar } from '../../actions/carActions';
...
class EditCar extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.cars.car) {
            ...
            this.setState({
                ...
                gorivo: car.gorivo,
                brojvrata: car.brojvrata,
                boja: car.boja,
                stanje: car.stanje,
                detalji: car.detalji,
                imageName: car.slika.imageName,
                imageData: car.slika.imageData
            });
        }
    }
    ...
    onSubmit(e) {
        ...
        this.props.deleteCar(this.props.cars.car._id, this.props.history);
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 m-auto">
                            <h3 className="text-center mb-3">Azuriranje automobila</h3>
                            <form onSubmit={this.onSubmit} noValidate>
                                ...
                                <button onSubmit={this.onSubmit} className="btn btn-primary btn-block mt-4 mb-4">Azuriraj</button>
                            </form>
                        </div>
                    </div>
                </div>
...
export default connect(mapStateToProps, { getCarByID, postCar, deleteCar })(withRouter(EditCar));